...
exports.index = function(req, res, next) {
    ...
    cache.render(req, res, function() {
        ...
        libtlks.talk.latest(config.mongodb, limit, null, function(err, talks) {
            ...
            libtlks.talk.popular(config.mongodb,
                limit,
                null,
                function(err, talks) {
                    if (err) {
                    ...
                    var filePath = __dirname + "/../../src/views/index.jade";
...
exports.activity = function(req, res, next) {
    ...
    cache.render(req, res, function() {
        ...
        libtlks.talk.latest(config.mongodb, 25, null, function(err, talks) {
            ...
            var filePath = __dirname + "/../../src/views/activity.jade";
            var html = cache.compile(req.url, filePath, context);
            res.write(html);
            res.end();
        });
...
exports.login = function(req, res) {
    ...
    cache.render(req, res, function() {
        ...
        var filePath = __dirname + "/../../src/views/login.jade";
        var html = cache.compile(req.url, filePath, context);
        res.write(html);
        res.end();
    }, cache.hour1);
